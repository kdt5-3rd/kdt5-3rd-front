...
export default function Dashboard() {
  ...
  return (
    <div className='text-secondary-500 flex h-full min-h-screen flex-col bg-[#FAFAFA] sm:min-w-[1440px] sm:flex-row'>
      <Navigation />
      <div className='w-full min-w-[400px] sm:min-w-[752px]'>
